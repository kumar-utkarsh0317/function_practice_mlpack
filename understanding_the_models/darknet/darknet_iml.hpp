...
>
//if no argument is given to the constructor then nothing will be done by the constructor
...
//constrctor are defined in two ways first in tuple form and other in argument form 
template<
     typename OutputLayerType,
     typename InitializationRuleType,
     size_t DarkNetVersion
...
//actual implementation will be given to the tuple format and the argument format will copy its implementation
template<
     typename OutputLayerType,
     typename InitializationRuleType,
     size_t DarkNetVersion
...
DarkNet<OutputLayerType, InitializationRuleType, DarkNetVersion>::DarkNet(
    ...
    const std::string& weights,
    const bool includeTop) :
    //class member values are assigned
